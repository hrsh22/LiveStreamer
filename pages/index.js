      ...
      <div className="w-full md:w-1/2 md:px-3">
        <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
            <span className="block xl:inline">Live</span>
            <span className="block text-indigo-600 xl:inline">Streamer</span>
          </h1>
          <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">Experience the future of decentralized media with our web3 live streaming app.</p>
          <div className="relative flex flex-col sm:flex-row sm:space-x-4">
            <a href="user/address" className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-indigo-600 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
              Go to Streams
        ...
        <div className="box-border order-first w-full text-black border-solid md:w-1/2 md:pl-10 md:order-none">
            ...
            <ul className="p-0 m-0 leading-6 border-0 border-gray-300">
                <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                    <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span> Enjoy your favorite content
                </li>
                <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                    <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span> Learn top skills
                </li>
                <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                    <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span> Talk to the creators
                </li>
            </ul>
        </div>
    </div>
...
<div className="box-border w-full text-black border-solid md:w-1/2 md:pl-6 xl:pl-32">
            ...
            <ul className="p-0 m-0 leading-6 border-0 border-gray-300">
                <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                    <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span> Watch recorded streams
                </li>
                <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                    <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span> Mint NFTs of Live Streams
                </li>
                <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                    <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span> Watch live streams
                </li>
            </ul>
        </div>
    ...
    <div className="flex flex-wrap items-center -mx-3">
      <div className="order-1 w-full px-3 lg:w-1/2 lg:order-0">
        <div className="w-full lg:max-w-md">
          <h2 className="mb-4 text-3xl font-bold leading-tight tracking-tight sm:text-4xl font-heading">Jam-packed with all the features you need for a seamless viewing experience!</h2>
          <p className="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">It&apos;s never been easier to watch and interact with your favourite creators. Our app will help you with the following:</p>
          <ul>
            <li className="flex items-center py-2 space-x-4 xl:py-3">
              ...
              <span className="font-medium text-gray-500">Seamless access to LiveStreams from anywhere</span>
            </li>
            <li className="flex items-center py-2 space-x-4 xl:py-3">
              ...
              <span className="font-medium text-gray-500">Monitization of content for creators</span>
            </li>
            <li className="flex items-center py-2 space-x-4 xl:py-3">
              <svg className="w-8 h-8 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
              <span className="font-medium text-gray-500">100% Protection and Security for your identity</span>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div className="px-16 bg-white">
        <div className="container flex flex-col items-start mx-auto lg:items-center">
            ...
            <h2 className="relative flex items-start justify-start w-full max-w-3xl text-5xl font-bold lg:justify-center">
                ...
                Collaborator</h2>
                <div className="block w-full h-0.5 max-w- mt-6 bg-purple-100 rounded-full"></div>

            <div className="items-center justify-center w-full mt-12 mb-4 lg:flex ">
                <div className="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-2/3 lg:mb-0 m-5 p-10 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 ">
                    <div className="flex items-center justify-center">
                        ...
                        <div className="flex flex-col items-start justify-center">
                            <h4 className="font-bold text-gray-800">Ayush Shete</h4>
                            <p className="text-gray-600">Student</p>
                        </div>
                    </div>
                    <blockquote className="mt-8 text-lg text-gray-500">Developer</blockquote>
                </div>
                ...
                <div className="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-2/3 lg:mb-0 m-5 p-10 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 ">
                    <div className="flex items-center justify-center">
                        ...
                        <div className="flex flex-col items-start justify-center">
                            <h4 className="font-bold text-gray-800">Harsh Gupta</h4>
                            <p className="text-gray-600">Student</p>
                        </div>
                    </div>
                    <blockquote className="mt-8 text-lg text-gray-500">Developer</blockquote>
...
<section className="bg-white">
    <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mt-8 space-x-6">
            ...
            <a href="https://github.com/ayushete02/LiveStreamer" className="text-gray-400 hover:text-gray-500">
